...
export const profile: ProfileData = {
  ...
  heroImage: "/kamila-hero.jpg",
  cardSubtitle: "Beleza autoral · Estética premium",
};

export const chips = [
  "+1000 atendimentos",
  "Micropigmentação de assinatura",
  "Perfumes árabes originais",
  "Studio premium em Bauru",
];
...
export const testimonials: Testimonial[] = [
  {
    name: "Larissa P.",
    quote:
      "A Kamila traduz elegância em cada detalhe. O resultado ficou sofisticado, leve e extremamente natural.",
  },
  {
    name: "Renata M.",
    quote:
      "Atendimento impecável, ambiente refinado e técnica de alto nível. A remoção a laser foi segura e eficiente.",
  },
  {
    name: "Carolina S.",
    quote:
      "Os perfumes árabes são uma experiência sensorial. Fragrâncias marcantes com presença realmente memorável.",
  },
];
